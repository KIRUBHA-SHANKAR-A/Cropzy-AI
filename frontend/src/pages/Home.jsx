...
const Homepage = () => {
  ...
  return (
    <div className="pt-24 pb-16 px-4 min-h-screen w-full bg-gradient-to-br from-green-50 via-white to-amber-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
