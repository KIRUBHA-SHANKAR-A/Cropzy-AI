...
const Homepage = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-green-50 via-white to-amber-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      <div className="pt-24 pb-16 px-4 w-full overflow-x-auto">
        <div className="max-w-7xl mx-auto min-w-[320px]">
          {/* Hero Section */}
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            <div>
              <div className="inline-flex items-center bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 px-4 py-2 rounded-full text-sm font-medium mb-6 whitespace-nowrap">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-8">
                <div className="flex items-center gap-3 p-3 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-green-100 dark:border-gray-700 hover:shadow-md transition">
                  <div className="w-10 h-10 bg-green-100 dark:bg-green-900/30 rounded-lg flex items-center justify-center text-green-600 dark:text-green-400 text-xl flex-shrink-0">
                    ✓
                  </div>
                  <div>
              ...
              <div className="relative">
                <div className="absolute -bottom-6 -left-6 bg-white dark:bg-gray-800 p-4 rounded-xl shadow-lg hidden md:block">
                  <div className="flex items-center space-x-3">
                    ...
                    <p className="font-bold text-gray-900 dark:text-white whitespace-nowrap">{t('home.hero.aiBadge')}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <section className="py-16">
            <div className="text-center mb-8">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mt-4 mb-4 break-words">
                {t('home.carousel.title')}
              </h2>
              <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto break-words">
          ...
          <section className="py-16">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white break-words">
                {t('home.howItWorks.title')}
              </h2>
              <p className="text-xl text-gray-600 dark:text-gray-400 mt-4 break-words">
          ...
          <section className="py-16">
            <div className="text-center mb-12">
              <span className="text-green-600 dark:text-green-400 font-semibold text-sm uppercase tracking-wider bg-green-100 dark:bg-green-900/30 px-4 py-2 rounded-full inline-block">
                {t('home.features.badge')}
              </span>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mt-4 break-words">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {coreFeatures.map((feature, index) => (
                ...
                >
                  ...
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2 group-hover:text-green-600 transition break-words">
                    {feature.title}
                  </h3>
                  <p className="text-gray-600 dark:text-gray-400 break-words">{feature.desc}</p>
                </Link>
              ))}
            </div>
          </section>
